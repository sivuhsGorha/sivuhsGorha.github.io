...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class CommonClass {
      constructor() {
        this.width = 0; this.height = 0; this.time = 0; this.delta = 0;
    ...
    class Simulation {
      ...
      update() {
        this.boundarySpace[this.options.isBounce ? 'set' : 'copy'](this.options.isBounce ? 0 : this.cellScale, this.options.isBounce ? 0 : this.cellScale);
        ...
        this.output = new THREE.Mesh(
          ...
          new THREE.RawShaderMaterial({
            ...
            uniforms: {
              ...
              palette: { value: paletteTex }, bgColor: { value: bgVec4 }, lightMode: { value: lightMode }
            }
          })
        );
