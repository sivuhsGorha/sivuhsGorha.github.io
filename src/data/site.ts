export const site = {
    ...
    mark: 'SBK.dev',
    title: 'Sibongakonke Simamane — Junior Systems Developer in Durban, South Africa',
    metaDescription:
        'Junior Systems Developer in Durban, South Africa with expertise across Java, PHP, JavaScript, React, Node.js, Docker, AWS, and MySQL. Focusing on full-stack development, cloud infrastructure, and cybersecurity.',
